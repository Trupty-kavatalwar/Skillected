...
const user1 = createUser('Saurabh', 'Pandey', 'saurabh@gmail.com', 19, "my address");
console.log(user1);
...
const user3 = createUser('mohit', 'ved', 'mohit@gmail.com', 17, "my address");
console.log(user3);
...
// const person1 = new Person("Saurabh", "Pandey", 5);
// console.log(person1.fullName());
// console.log(person1.fullName);
// person1.fullName = "Saurabh Pandey";
// console.log(person1);
...
// const person1 = new Person("Saurabh ", "Pandey", 8);
